...
void infoJugador(){
	...
	printf(" 2.- Castellano");
	printf(" 3.- English");
	printf("(CAT=0)Selecciona l'idioma \n(ESP=1)Selecciona el idioma \n(ENG=2) Choose the language \n");
	scanf("%d", &opcio); 
	...
	switch (opcio){
		...
		default:
			printf("Indica un dels idiomes disponibles / Indica uno de los idiomas disponibles / Indicate one of the available languages");
	}
